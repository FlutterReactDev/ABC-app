...
export const Object: FC<ObjectProps> = ({
    modalOpen = false,
    address,
    appartament,
    area,
                    ...
                    <div className="bg-white p-4 flex flex-col gap-4 text-[13px] cursor-pointer rounded-sm">
                        ...
                        <div className="flex justify-between items-center flex-wrap gap-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    <CircleAlert className="w-3 h-3" /> Старт
                                    продаж
                                </Badge>
                            </div>
                        </div>
                            ...
                            <div className="bg-white p-4 flex flex-col gap-4 text-[13px]">
                                <div>
                                    <Badge>
                                        ...
                                        среднем продается 29 квартир в месяцю
                                    </Badge>
                                </div>
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <p>
                                            В ЖК Прокшино можно найти квартиры с
                                            высокими потолками, а также
                                            уникальными планировками. В шаговой
                                            доступности есть все необходимые
                                            объекты инфраструктуры, а из окон
                                            открываются живописные вида на реку
                                            Сосновку. Комплекс расположен в
                                            непосредственной близости от крупных
                                            природных лесопарков с
                                            благоустроенными дорожками для пеших
                                            и велосипедных прогулок и зонами
                                            отдыха.
                                        </p>
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <p>
                                            ЖК "Прокшино" расположено всего в 10
                                            минутах ходьбы от ст.м Прокшино,
                                            рядом с багоустроенной набережной.
                                            Рядом строится крупный
                                            бизнес-квартал с торговым центром и
